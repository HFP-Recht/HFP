...
![[Pasted image 20240523171225.png]]### Teil 2: Prezitext

| Text für den Referenten                                                                                                                                                                                                                                                                     | Wichtiger Begriff            | Analogie                                                                                                                                   | Interaktionsfragen                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bei **Verträgen auf Arbeitsleistung** verpflichtet sich eine Person, eine bestimmte Arbeitsleistung zu erbringen. Diese Verträge sind in verschiedene Typen unterteilt, die je nach Art der Tätigkeit und den beteiligten Parteien variieren.                                               | Verträge auf Arbeitsleistung | Diese Vertragsarten sind wie unterschiedliche Arten von Arbeitsverhältnissen: fest angestellt, projektbasiert oder freiberuflich.          | Können Sie ein Beispiel für einen Vertrag auf Arbeitsleistung nennen? <br> (Antwort: Ja, z.B. der Arbeitsvertrag eines Mechanikers.)                                                                        |
| Der **Arbeitsvertrag** (Art. 319–362 OR) ist ein Vertrag, bei dem ein Arbeitnehmer gegen Lohn eine Arbeitsleistung nach Weisung des Arbeitgebers erbringt. Ein Beispiel wäre ein Mitarbeiter in einer Bank oder eine Haushaltshilfe.                                                        | Arbeitsvertrag               | Ein Arbeitsvertrag ist wie ein Vollzeitjob mit klaren Aufgaben und festem Gehalt.                                                          | Welche Verpflichtungen hat ein Arbeitnehmer in einem Arbeitsvertrag? <br> (Antwort: Weisung des Arbeitgebers befolgen, Arbeit sorgfältig ausführen.)                                                        |
...
#### Folie 5: Voraussetzungen eines Arbeitsvertrags

a) **Arbeitsleistung und Lohn**
   - Vertrag gültig auch ohne Lohnvereinbarung (OR 320 II)
   - Üblicher Lohn gilt (OR 322 I)

b) **Schriftform**
   - Grundsätzlich formfrei (OR 320 I)
   - Ausnahmen: Lehrvertrag (OR 344a I), Handelsreisendenvertrag (OR 347a I)
   - Einzelne Klauseln schriftlich (z.B. Konkurrenzverbot, OR 340 I)
[Link zu Art. 320 OR](https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de#art_320)
[Link zu Art. 344a OR](https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de#art_344a)
[Link zu Art. 347a OR](https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de#art_347a)
[Link zu Art. 340 OR](https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de#art_340)

---

#### Folie 6: Wichtige Gesetze im Arbeitsrecht

a) **Obligationenrecht (OR)**
   - Abschluss, Inhalt, Beendigung von Arbeitsverhältnissen
[Link zu OR](https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de)

b) **Arbeitsgesetz (ArG)**
   - Arbeitnehmerschutz, Gesundheitsschutz, Arbeitszeiten
[Link zu ArG](https://www.fedlex.admin.ch/eli/cc/1948/678_678_678/de)

c) **Gleichstellungsgesetz (GIG)**
   - Gleichstellung von Mann und Frau
[Link zu GIG](https://www.fedlex.admin.ch/eli/cc/1996/1498_1498_1498/de)

d) **Berufsbildungsgesetz (BBG)**
   - Berufliche Grundbildung und Weiterbildung
[Link zu BBG](https://www.fedlex.admin.ch/eli/cc/2002/174/de)

---

#### Folie 7: Zwingende und dispositive Gesetzesnormen

- **Zwingende Normen**
  - Nicht abänderbar oder nur zugunsten des Arbeitnehmers

- **Dispositive Normen**
  - Abänderbar durch Vertrag
  - Gelten, wenn nichts anderes vereinbart
...
| Text für den Referenten  | Wichtiger Begriff | Analogie | Interaktionsfragen |
|-------------------------|-------------------|----------|--------------------|
| Nach OR 320 I muss ein **Arbeitsvertrag** nur dann schriftlich abgeschlossen werden, wenn das Gesetz dies vorschreibt. Einige wichtige Formvorschriften sind in den Artikeln 321c.3, 340.1 und 344a.1 OR enthalten. | Formvorschriften | Formvorschriften sind wie die Regeln beim Abschluss eines Vertrags. | Welche Formvorschriften kennen Sie, die einen schriftlichen Vertrag erfordern? <br> (Antwort: Lehrvertrag, Konkurrenzverbot.) |
| Ein Arbeitsvertrag entsteht, wenn die vier allgemeinen **Voraussetzungen der Vertragsentstehung** erfüllt sind. Dies sind: übereinstimmende Willensäußerung, Handlungsfähigkeit, Einhaltung der Formvorschriften, zulässiger Inhalt. | Vertragsentstehung | Vertragsentstehung ist wie das Legen eines Fundaments für ein Haus. | Was passiert, wenn eine dieser Voraussetzungen nicht erfüllt ist? <br> (Antwort: Der Vertrag ist nicht gültig.) |
| OR 319 I definiert den **Einzelarbeitsvertrag**. Ein Arbeitnehmer verpflichtet sich zur Arbeitsleistung, folgt den Weisungen des Arbeitgebers, der Vertrag ist dauerhaft und der Arbeitgeber schuldet Lohn. | Einzelarbeitsvertrag | Ein Einzelarbeitsvertrag ist wie ein Arbeitsvertrag, der die täglichen Pflichten und Rechte regelt. | Warum ist es wichtig, diese Merkmale zu kennen? <br> (Antwort: Um die Pflichten und Rechte zu verstehen.) |
| Der **Werkvertrag** und der **Auftrag** unterscheiden sich vom Arbeitsvertrag. Der Werkunternehmer schuldet ein Werk, der Beauftragte eine Dienstleistung. | Unterschied Werkvertrag und Auftrag | Der Unterschied ist wie der zwischen einem fertigen Produkt und einer erbrachten Dienstleistung. | Können Sie ein Beispiel für einen Werkvertrag nennen? <br> (Antwort: Bau einer Turnhalle.) |
| Für den Abschluss eines **Arbeitsvertrags** gelten grundsätzlich keine Formvorschriften. Ausnahmen sind der Lehrvertrag und der Handelsreisendenvertrag. Einige Vertragsklauseln, wie das Konkurrenzverbot, müssen schriftlich vereinbart werden. | Formfreiheit | Formfreiheit ist wie die Flexibilität bei der Gestaltung eines Vertrages. | Welche Vorteile bietet die Formfreiheit? <br> (Antwort: Flexibilität und einfache Abmachungen.) |
| Wichtige Gesetze im Arbeitsrecht sind das **Obligationenrecht**, das **Arbeitsgesetz**, das **Gleichstellungsgesetz** und das **Berufsbildungsgesetz**. Diese regeln verschiedene Aspekte des Arbeitslebens. | Wichtige Gesetze | Diese Gesetze sind wie verschiedene Regelwerke, die zusammen das Arbeitsrecht bilden. | Welche dieser Gesetze kennen Sie und welche sind für Ihre Arbeit besonders relevant? <br> (Antwort: Arbeitsgesetz für Arbeitnehmerschutz.) |
| **Zwingende** Gesetzesnormen dürfen nicht geändert werden, während **dispositive** Normen durch Vertrag abgeändert werden können. Dispositives Recht gilt nur, wenn nichts anderes vereinbart wurde. | Zwingende und dispositive Normen | Zwingende Normen sind wie unumstößliche Regeln, dispositive wie flexible Vereinbarungen. | Können Sie ein Beispiel für eine zwingende Norm nennen? <br> (Antwort: Mindesturlaubstage.) |
